...
from honestroles.plugins.types import LoadedPlugin, PluginKind
...
class PluginRegistry:
    ...
    @classmethod
    def from_plugins(cls, plugins: tuple[LoadedPlugin, ...]) -> "PluginRegistry":
    ...
    def plugins_for_kind(self, kind: PluginKind) -> tuple[LoadedPlugin, ...]:

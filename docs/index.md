...
1. [App Quickstart](app/get-started.md)
2. [Upload Data](app/upload-data.md)
3. [Run Analysis](app/run-analysis.md)
4. [Export Results](app/export-results.md)

## Choose Your Path

- App user (browser): start at [honestroles.com](https://honestroles.com)
